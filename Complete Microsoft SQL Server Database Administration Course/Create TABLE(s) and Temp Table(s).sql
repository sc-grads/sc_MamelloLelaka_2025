DROP TABLE IF EXISTS [AdventureWorks2019].[sales].[storesnew];

GO

DROP TABLE IF EXISTS [AdventureWorks2019].[sales].[visits];
...
-- please see the difference we are creating store_id as primary key
